...
export const content = {
  en: {
    ...
    menu: {
      ...
      openBuffet: {
        navLabel: 'Open Buffet',
        eyebrow: 'Standard Package',
        title: 'Open Buffet',
        subtitle: 'A complete buffet experience — every dish served with warmth and generosity.',
        mainItemsTitle: 'Main Dishes',
        items: [
          'Basmati rice',
          'Oven-baked pasta',
          'Grilled chicken (jareeld)',
          'Grilled kofta',
          'Chicken tawook',
          'Meat piccata',
          'Sambousek',
        ...
        note: 'Prices are indicative. Final pricing is confirmed based on your event details.',
    ...
    order: {
      ...
      details: { number: 'Step 03', title: 'How should we reach you?', copy: 'Our team will use these details to prepare your quote.', name: 'Full name', mobile: 'Egyptian mobile number', email: 'Email address', notes: 'Anything else we should know?', notesHint: 'Special requests, venue details, ideas...' },
      review: { number: 'Step 04', title: 'One last look.', copy: 'Make sure everything feels right, then we’ll take it from here.', event: 'Delivery', selections: 'Your selections', details: 'Your details', type: 'Event type', date: 'Date', time: 'Time', guestCount: 'Guest count', city: 'City', address: 'Address', services: 'Services', budget: 'Budget', name: 'Name', phone: 'Phone', consent: 'I agree that Standard may contact me about this order.' },
    ...
    legal: {
      ...
      p: {
        ...
        orderFormText: 'event type, date, guest count, city, services requested, budget range, name, phone number, email (optional).',
  ...
  ar: {
    ...
    menu: {
      ...
      openBuffet: {
        navLabel: 'البوفيه المفتوح',
        eyebrow: 'الباقة الأساسية',
        title: 'البوفيه المفتوح',
        subtitle: 'تجربة بوفيه متكاملة — كل طبق يُقدَّم بدفء وكرم.',
        mainItemsTitle: 'الأطباق الرئيسية',
        items: [
          'أرز بسمتي',
          'مكرونة فرن',
          'جريلد تشيكن',
        ...
        note: 'الأسعار استرشادية. يتم تأكيد السعر النهائي بناءً على تفاصيل مناسبتك.',
        cta: 'اطلب هذه الباقة',
      },
    },
    about: {
    ...
    order: {
      ...
      details: { number: 'الخطوة 03', title: 'كيف نصل إليك؟', copy: 'سيستخدم فريقنا هذه البيانات لإعداد عرض السعر.', name: 'الاسم بالكامل', mobile: 'رقم هاتف مصري', email: 'البريد الإلكتروني', notes: 'هل هناك أي تفاصيل أخرى؟', notesHint: 'طلبات خاصة أو تفاصيل المكان أو أفكار...' },
      review: { number: 'الخطوة 04', title: 'نظرة أخيرة.', copy: 'تأكد أن كل شيء صحيح، ثم سنتولى الباقي.', event: 'التوصيل', selections: 'اختياراتك', details: 'بياناتك', type: 'نوع المناسبة', date: 'التاريخ', time: 'الوقت', guestCount: 'عدد الضيوف', city: 'المدينة', address: 'العنوان', services: 'الخدمات', budget: 'الميزانية', name: 'الاسم', phone: 'الهاتف', consent: 'أوافق على أن تتواصل معي ستاندرد بخصوص هذا الطلب.' },
      submit: 'أرسل طلبي',
    ...
    legal: {
      ...
      p: {
        ...
        orderFormText: 'نوع المناسبة، التاريخ، عدد الضيوف، المدينة، الخدمات المطلوبة، الميزانية، الاسم، رقم الهاتف، البريد الإلكتروني (اختياري).',
