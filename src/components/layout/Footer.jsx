...
export default function Footer() {
  ...
  return <footer className="site-footer">
    ...
    <div className="shell footer__bottom"><span>© {new Date().getFullYear()} Standard Catering. {c.footer.rights}</span><span><a href="https://webhub.web-hub-info-2026.workers.dev/" target="_blank" rel="noreferrer" style={{color: 'inherit', textDecoration: 'none'}}>{c.footer.made}</a></span></div>
  </footer>
}
